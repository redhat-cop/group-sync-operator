...
type GitHubSyncer struct {
	...
	CachedTeams       map[string]*github.Team
	CachedTeamMembers map[string][]*github.User
...
func (g *GitHubSyncer) Init() bool {
	...
	g.CachedTeamMembers = make(map[string][]*github.User)
	g.CachedTeams = make(map[string]*github.Team)
