...
func (k *OktaSyncer) Init() bool {
	...
	_,_, err := okta.NewClient(context.TODO(), okta.WithOrgUrl(k.Provider.URL))
...
func (k *OktaSyncer) Validate() error {
...
func (k *OktaSyncer) Sync() ([]userv1.Group, error) {
...
func (k *OktaSyncer) processGroupsAndMembers(group, parentGroup *gocloak.Group, scope redhatcopv1alpha1.SyncScope) error {
...
func (k *OktaSyncer) diff(lhsSlice, rhsSlice []*gocloak.User) (lhsOnly []*gocloak.User, rhsOnly []*gocloak.User) {
	return k.singleDiff(lhsSlice, rhsSlice), k.singleDiff(rhsSlice, lhsSlice)
}

func (k *OktaSyncer) singleDiff(lhsSlice, rhsSlice []*gocloak.User) (lhsOnly []*gocloak.User) {
...
func (k *OktaSyncer) GetProviderName() string {
	return k.Name
}
